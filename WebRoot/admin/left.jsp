			  ...
			  <tr>
				...
				<div id="container">
				  ...
				  <div class="content">
					...
					<ul class="MM">
					  <li><a href="Admin_listCustoms.action" target="MainFrame">客户查询</a></li>
					  <li><a href="Admin_addCustomShow.action" target="MainFrame">新增客户</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">汽车信息管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listCars.action" target="MainFrame">汽车查询</a></li>
					  <li><a href="Admin_addCarShow.action" target="MainFrame">新增汽车</a></li>
					</ul>
				  </div>
				  <h1 class="type"><a href="javascript:void(0)">汽车租赁管理</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listRentals.action" target="MainFrame">汽车租赁查询</a></li>
					  <li><a href="Admin_addRentalShow.action" target="MainFrame">新增汽车租赁</a></li>
					</ul>
				  </div>
				  </c:if>
