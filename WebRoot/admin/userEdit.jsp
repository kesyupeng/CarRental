     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
        ...
        <tr>
          ...
          <td>
            <s:textfield name="paramsUser.user_phone" id="paramsUser.user_phone" value="%{#attr.user.user_phone}"/>
          </td> 
        </tr>
         <tr>
          <td align="right" style="padding-right:5px">邮箱：</td>
          <td>
          	<s:textfield name="paramsUser.user_mail" id="paramsUser.user_mail" value="%{#attr.user.user_mail}"/>
          </td>
        </tr>
     </table>
     </td>
